...
class CWebUser extends CApplicationComponent implements IWebUser
{
	...
	public function getReturnUrl($defaultUrl=null)
	{
		if($defaultUrl===null)
		{
			...
			Yii::log(Yii::app()->getUrlManager()->showScriptName, CLogger::LEVEL_ERROR);
			Yii::log(Yii::app()->getRequest()->getScriptUrl(), CLogger::LEVEL_ERROR);
			Yii::log(Yii::app()->getRequest()->getBaseUrl().'/', CLogger::LEVEL_ERROR);
		}
		else
		{
			$defaultReturnUrl=CHtml::normalizeUrl($defaultUrl);
			Yii::log(CHtml::normalizeUrl($defaultUrl), CLogger::LEVEL_ERROR);
		}
